...
{
    public class CouesesController : Controller
    {
        private readonly SchoolmanagementDbContext _context;

        public CouesesController(SchoolmanagementDbContext context)
        {
            _context = context;
        }
